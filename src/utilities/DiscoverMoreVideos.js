import sampleThumbnail from '@/assets/images/gym3_homepage.png';
...
export const UpperBodyVideos = [
  ...
  },
  {
    ...
    description: {
      howToDoIt:
        'Sit on the machine with your feet flat. Push the handles forward until your arms are straight, then slowly bring the handles back.',
      do: [
  ...
  },
  {
    ...
    description: {
      howToDoIt:
        'Lie on a bench with a weight in each hand or use a barbell. Lower the weights to your chest, then push them back up.',
  ...
  },
  {
    ...
    description: {
      howToDoIt:
        'Hold a dumbbell in each hand, arms at your sides. Curl the weights up to your shoulders, then lower slowly.',
...
export const LowerBodyVideos = [
  {
    ...
    description: {
      howToDoIt:
        'Stand upright with feet hip-width apart. Step forward with one leg, lowering your hips until both knees are bent at about 90 degrees. The back knee should hover just above the floor. Push back up to the starting position and repeat on the other leg.',
      do: [
      ...
      dont: [
        ...
        "Don't let your upper body lean forward or twist.",
